...
class CouponModelOutput {
  /// Returns a new [CouponModelOutput] instance.
  CouponModelOutput({
    required this.id,
  ...
  AppUtilsEnumsCouponStatus status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CouponModelOutput &&
    other.id == id &&
  ...
  /// Returns a new [CouponModelOutput] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CouponModelOutput? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CouponModelOutput[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CouponModelOutput[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CouponModelOutput(
        ...
        status: AppUtilsEnumsCouponStatus.fromJson(json[r'status'])!,
  ...
  static List<CouponModelOutput> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CouponModelOutput>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CouponModelOutput.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CouponModelOutput> mapFromJson(dynamic json) {
    final map = <String, CouponModelOutput>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CouponModelOutput.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CouponModelOutput-objects as value to a dart map
  static Map<String, List<CouponModelOutput>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CouponModelOutput>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CouponModelOutput.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
