...
class CouponModelInput {
  /// Returns a new [CouponModelInput] instance.
  CouponModelInput({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CouponModelInput &&
    other.id == id &&
  ...
  /// Returns a new [CouponModelInput] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CouponModelInput? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CouponModelInput[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CouponModelInput[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CouponModelInput(
        ...
        status: CouponStatusInput.fromJson(json[r'status'])!,
  ...
  static List<CouponModelInput> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CouponModelInput>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CouponModelInput.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CouponModelInput> mapFromJson(dynamic json) {
    final map = <String, CouponModelInput>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CouponModelInput.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CouponModelInput-objects as value to a dart map
  static Map<String, List<CouponModelInput>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CouponModelInput>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CouponModelInput.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
